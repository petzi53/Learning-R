...
### [The data](https://github.com/petzi53/oiLabs-dplyr-ggplot/blob/master/05_sampling_distributions/sampling_distributions.Rmd#the-data)
...
## [The unknown sampling distribution](https://github.com/petzi53/oiLabs-dplyr-ggplot/blob/master/05_sampling_distributions/sampling_distributions.Rmd#the-unknown-sampling-distribution)
